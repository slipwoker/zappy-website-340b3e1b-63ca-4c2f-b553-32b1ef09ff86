document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateContactForm(e) {
        ...
        if (nameField) {
            ...
            if (!nameValue) {
                ...
                isValid = false;
                if (!firstError) firstError = nameField;
    ...
    function showError(field, message) {
        ...
        const rtlDirection = getComputedStyle(field).direction === 'rtl' || 
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '340b3e1b-63ca-4c2f-b553-32b1ef09ff86',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '340b3e1b-63ca-4c2f-b553-32b1ef09ff86';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '340b3e1b-63ca-4c2f-b553-32b1ef09ff86';
